        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left">
            ...
            <motion.h2
              ...
              className="title-hero text-slate-900 dark:text-white mb-6 transition-colors duration-300"
            >
            ...
            <motion.p
              ...
              className="subtitle-crypto mb-10 max-w-xl text-slate-500 dark:text-slate-400 text-lg transition-colors duration-300"
            >
            ...
            <div className="space-y-6">
              {[
                ...
                <motion.div 
                  ...
                  className="flex items-center gap-3 text-sm font-bold text-slate-800 dark:text-slate-200 uppercase tracking-widest transition-colors duration-300"
                >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {reasons.map((reason, index) => (
              <motion.div
                ...
                className="group p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900/60 shadow-sm hover:shadow-2xl transition-all duration-500"
              >
                <div 
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3 tracking-tight group-hover:text-purple-600 transition-all uppercase duration-300 leading-tight">
                  {reason.title}
                </h3>
                <p className="text-[14px] text-slate-500 dark:text-slate-400 font-medium leading-relaxed transition-colors duration-300">
                  {reason.desc}
                </p>
              </motion.div>
            ))}
